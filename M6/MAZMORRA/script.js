...
function movimiento(desp){
    ...
    if(desp == 1){
        //ARRIBA
        if((personajeY - 1 ) >= 0 && arrayBidimensional[personajeY - 1][personajeX] != 1){
            personajeY--;
            mueveCanvas();
            checkMeta();
    ...
    if(desp == 2){
        //ABAJO
        if((personajeY + 1 ) < arrayBidimensional.length && arrayBidimensional[personajeY + 1][personajeX] != 1){
            personajeY++;
            mueveCanvas();
            checkMeta();
        }else if(arrayBidimensional[personajeY + 1][personajeX] == 1){
    ...
    if(desp == 3){
        //IZQUIERDA
        if((personajeX - 1 ) >= 0 && arrayBidimensional[personajeY][personajeX -1] != 1){
            personajeX--;
            mueveCanvas();
            checkMeta();
    ...
    if(desp == 4){
        //DERECHA
        if((personajeX + 1 ) < arrayBidimensional[0].length && arrayBidimensional[personajeY][personajeX +1] != 1){
            personajeX++;
            mueveCanvas();
            checkMeta();
        }else if(arrayBidimensional[personajeY][personajeX +1] == 1){
