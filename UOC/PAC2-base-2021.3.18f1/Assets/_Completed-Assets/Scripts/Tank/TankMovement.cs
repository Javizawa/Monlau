    ...
    public class TankMovement : NetworkBehaviour
    {
        ...
        public override void OnStartLocalPlayer()
        {
            foreach (MeshRenderer child in GetComponentsInChildren<MeshRenderer>())
            {
                ...
                child.material.color = colorGuardado;
            }
        }
        ...
        public override void OnStartServer()
        {
            ...
            Debug.Log("EL SERVER SE CONECTA" + this.gameObject);
            //this.gameObject.GetComponentInChildren<TextMeshPro>().SetText(PlayerPrefs.GetString("Nombre"));
            gameManager.AddTank(this.gameObject);
            }
        }
        ...
        {
            base.OnStartClient();
            Debug.Log("EL CLIENTE SE CONECTA" + this.gameObject);
            gameManager.AddTank(this.gameObject);
            //GameObject.Find("InputPlayer").text = 'TEXT' ;
